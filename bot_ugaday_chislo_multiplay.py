...
# Функция, которая возвращает словарь с данными всех пользователей игравших в игру
def read_users_xlsx():
    df = pd.read_excel('users.xlsx')
    players = {}
    for el in df.values:
        id, name, in_game, secret_number, attempts, total_games, wins  = el
        players[id] = {'in_game':in_game, 'secret_number':secret_number,
                       'attempts':attempts, 'total_games':total_games, 'wins':wins}
    return players

# Словарь, в котором будут храниться данные пользователя
users = read_users_xlsx()
